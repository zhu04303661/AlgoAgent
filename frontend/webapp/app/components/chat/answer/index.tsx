...
const AcceptIcon: FC<{ className?: string }> = ({ className }) => {
  return (
    <svg width="16" height="16" viewBox="0 0 16 16" fill="none" xmlns="http://www.w3.org/2000/svg" className={className}>
      <path d="M13.3332 4L5.99984 11.3333L2.6665 8" stroke="#6B7280" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" />
    </svg>
  )
}
    ...
    const userOperation = () => {
      return feedback?.rating
        ...
        : <div className='flex gap-1'>
          ...
          <Tooltip selector={`accept-answer-${randomString(16)}`} content="接受并保存到代码区">
            {OperationBtn({
              innerContent: <IconWrapper><AcceptIcon /></IconWrapper>,
