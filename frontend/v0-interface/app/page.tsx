  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="w-64 border-r border-gray-200 p-4 flex flex-col">
        ...
        <button className="sidebar-item bg-gray-100 mb-4">
        ...
        <div className="mt-8">
          ...
          <a href="#" className="text-sm text-primary mt-2 hover:underline block">View All</a>
        </div>
        <div className="mt-8">
      ...
      <div className="flex-1 p-8 overflow-y-auto">
        <div className="max-w-4xl mx-auto">
          ...
          <div className="relative mb-8">
            <input type="text" placeholder="Ask v0 to build..."
          ...
          <div className="mb-8">
            <div className="flex justify-between items-center mb-4">
              ...
              <a href="#" className="text-primary hover:underline">Browse All</a>
            </div>
            ...
            <div className="grid grid-cols-2 gap-6">
              <div className="border border-gray-200 rounded-lg overflow-hidden">
                <img src="https://ai-public.mastergo.com/ai/img_res/2c7d3615532b9ba0fa19ccd8f5388643.jpg"
                  alt="OpenAI and AI SDK Chatbot" className="w-full h-48 object-cover" />
                <div className="p-4">
              ...
              <div className="border border-gray-200 rounded-lg overflow-hidden">
                <img src="https://ai-public.mastergo.com/ai/img_res/0f5f0234c13cb97cb54f2946b725c7ff.jpg"
                  alt="AI Chat Interface" className="w-full h-48 object-cover" />
                <div className="p-4">
                  <div className="flex items-center mb-2">
              ...
              <div className="border border-gray-200 rounded-lg overflow-hidden">
                <img src="https://ai-public.mastergo.com/ai/img_res/62ca11a3c7d450248f05adca9b91a460.jpg"
                  alt="Two-column Login Card" className="w-full h-48 object-cover" />
                <div className="p-4">
                  <div className="flex items-center mb-2">
              ...
              <div className="border border-gray-200 rounded-lg overflow-hidden">
                <img src="https://ai-public.mastergo.com/ai/img_res/b38a279db63b1dc399e9bc8c0be498ba.jpg"
                  alt="Crypto Dashboard" className="w-full h-48 object-cover" />
                <div className="p-4">
                  <div className="flex items-center mb-2">
